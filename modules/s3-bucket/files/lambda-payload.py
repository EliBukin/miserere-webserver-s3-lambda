...
def funckey(event, context):
    ...
    s3_client.download_file('miserere-s3-for-packageparamiko','ssb.pem', '/tmp/file.pem')
    ...
    # command list
    commands = [
    #    "sudo wget https://raw.githubusercontent.com/EliBukin/SB-CloudFormation/4043a0e0cf416122b453eb21d2bb851df69b68ab/index.html -P /",
         "echo '<p>Vini Vidi Vici</p>' > /index.html"
        ]
